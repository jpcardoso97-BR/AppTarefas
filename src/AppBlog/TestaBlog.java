...
public class TestaBlog {
    public static void main(String[] args) {
        ...
        Usuario usuario4 = new Usuario("Joojin", 19);
        Usuario usuario5 = new Usuario("Joojinilson", 55);

        Postagem postagem = new Postagem(usuario,"Top 10 Animes battles", "(texto)", "22/09/2020");
        ...
        Comentario comentario4 = new Comentario(usuario4, "22/09/2020", "mim ajudem achegar nós 10 incritos,(link)");
